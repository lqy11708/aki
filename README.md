...
My best prediction accuracy on the validation data is 69.9% and 70% on test using Logistic Regression.
...
>Maximum Jaccard similarity of books<br> Mean and max Jaccard similarity of users<br> Mean Cosine similarity of books<br>Log of the two features <br>
